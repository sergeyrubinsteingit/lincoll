...
const LinksFilter = (props) => {
    ...
    const SelectedYearHandler = (event) => {
        ...
        props.on_GetSelectedYear(event.target.value);
        // props.on_GetSelectedYear('user selected year is: ' + event.target.value);
    };//[GetSelectedYear]
    ...
    <div className='links_filter'>
        ...
        <select value={props.selected_yr} onChange={SelectedYearHandler}>
